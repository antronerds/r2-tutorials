...
To play around with the concept, check out the tutorial on the [View a Gene analysis](One_Gene_View.md), the chapter on [Annotation Analyses](Annotation_Analyses.md), or find out how to make your ownn tracks in chapter [Adapt R2 to Your Needs](Adapting_R2.md).  
