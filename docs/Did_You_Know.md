...
Did You Know..? Explaining Abstract Concepts of R2
===========================================
...
![](_static/images/R2d2_logo.png)***What should I do with these complicated settings?***  
 --- 
Often R2 provides many possible settings. In the beginning this might be a bit overwhelming, but luckily often these settings are set to meaningful defaults.  
To get a better understanding of the meaning of these settings, read through these explanations of the recurring terms in the settings panels.  
