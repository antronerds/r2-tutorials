<a id="using_the_genome_browser_annoations"></a>

Using the R2-Genome browser annotations
===========================



*Add annotation to the R2 Genome browser*
...
-   In this tutorial we will provide an overview of many of the available Genome Browser Annotations that are publicly available.
