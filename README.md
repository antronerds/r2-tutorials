...
The "latest" manual is automatically rebuilt by ReadTheDocs when the GitHub repository is updated. This is done through a webhook that is generated in github with a link to a integration api url call as described here: https://docs.readthedocs.io/en/latest/webhooks.html#webhook-creation. To rebuild other versions, you'll need to be in the ReadTheDocs web site on the Build page.
