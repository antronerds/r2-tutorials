...
2.  Now we change to another dataset, Mixed Colon Adenocarcinoma (2022-v32) with a large collection of annotations including the CMS classification. Here the classification of the dataset we are using  is provided by R2 and is described in
